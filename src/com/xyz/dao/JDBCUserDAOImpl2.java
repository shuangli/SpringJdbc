...
public class JDBCUserDAOImpl2 implements UserDAO {
	...
	public void insertUser(User user) {
		...
		try {
			...
			closeJDBCResources(null, preparedStatement, connection);
		}
	}
	...
	public User selectUser(int userId) {
		...
		try {
			...
			closeJDBCResources(resultSet, preparedStatement, connection);
		}
		return null;
	}
	
	private static void closeJDBCResources(ResultSet resultSet, PreparedStatement preparedStatement, Connection connection) {
		try {
			/**
			 * Close the resultSet
			 */
